	...
	<div class="card" style="width: 40rem;">
		...
		<div class="card-body">
			...
			<form action="Signup" class="form-signin" method="POST">
				<p class="text">아이디</p>
				<input type="text" name="memId" id="member_id" class="form-control">
				&nbsp; &nbsp; <input type="button" id="overlay" onclick="overlay()"
					value="중복 체크" /><br>
				<p id="idch" class="check"></p>
				<p class="text">비밀번호</p>
				<input type="password" name="memPw" id="pw" class="form-control"><br>
				<p id="pw2ch" class="check"></p>
				<p class="text">비밀번호 확인</p>
				<input type="password" id="pw2" class="form-control"><br>
				<p id="pwch" class="check"></p>
				<p class="text">닉네임</p>
				<input type="text" name="memNic" id="name" class="form-control"><br>
				<p id="namech" class="check"></p>
				<p class="text">이름</p>
				<input type="text" name="memNm" id="name" class="form-control"><br>
				<p id="namech" class="check"></p>
				<p class="text">생년월일</p>
				<input type="text" name="memBir" id="birth_date"
					class="form-control" placeholder="19001010"><br>
				<p id="birth_check" class="check"></p>
				<p class="text">주소</p>
				<input type="text" class="text" id="sample4_postcode"
				...
				<input type="text" class="form-control" id="sample4_jibunAddress"
					name="memAddr" placeholder="지번주소" readonly="readonly"> <span
					id="guide" style="color: #999; display: block"></span> <br>
				<p class="text">이메일</p>
				<input type="email" name="memEmail" id="email" class="form-control">
				<!--          &nbsp; &nbsp; -->
				<!--         <input type="button" id="emoverlay" onclick="emoverlay()" value="중복 체크"/><br/> -->
				<p id="emch" class="check"></p>
				<p class="text">전화번호</p>
				<input type="text" name="memTel" id="phone" class="form-control"
