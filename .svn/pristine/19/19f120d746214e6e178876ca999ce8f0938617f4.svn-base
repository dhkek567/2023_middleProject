...
public class ReviewUpdateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/views/board/reviewUpdateForm.jsp").forward(req, resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String bafIdStr = req.getParameter("bafId");
		String bdRating = req.getParameter("bdRating");
		...
		BoardVO bv = new BoardVO(bdTitle, bdCont, bdRating);
		bv.setBdNo(bdNo);
		bv.setMemId(memId);
		...
		resp.sendRedirect(req.getContextPath() + "/board/reviewDetail.do?bdNo=" + bdNo);
	}
