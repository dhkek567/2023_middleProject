...
<div style="text-align: center;">
	...
	<form action="noticeUpdate.do?bdNo=<%=bv.getBdNo()%>" id="test" method="post" enctype="multipart/form-data">
...
%>
				...
				<div class="bt_wrap">
                	<a class="test" type="submit" class="on" onclick="document.getElementById('test').submit();" >공지사항 수정</a>
