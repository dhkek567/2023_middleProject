  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%">
	...
	<div class="card" style="width:40rem;">
		<div class="card-title" style="margin-top:30px;">
			...
			<h2 class="card-title" style="color:#e4932b;"><img src="/img/intrologo.png"/></h2>
		</div>
		<div class="card-body">
		
      <form action="/hospSignup.do" class="form-signin" method="POST" >
        <p class="text">협약병원 아이디</p>
        <input type="text" name="hospCd" id="member_id"  class="form-control" >
        &nbsp; &nbsp;
        <input type="button" id="overlay" onclick="overlay()" value="중복 체크"/><br>
        <p id="idch" class="check"> </p><br/>
        <p class="text">비밀번호</p>
        <input type="password" name="hospPw" id="pw" class="form-control" ><br>
        ...
        <p class="text">병원이름</p>
        <input type="text" name="hospNm" id="name" class="form-control" ><br>
        <p id="namech" class="check"> </p><br/>
        <p class="text">사업자번호</p>
        <input type="text" name="hospEntNo" id="name" class="form-control" ><br>
        <p id="namech" class="check"> </p><br/>
        <p class="text">협약 시작 날짜</p>
        <input type="text" name="hospPsStart" id="birth_date" class="form-control" placeholder="19001010 형식입니다."><br>
         <p id="birth_check" class="check"> </p><br/>
        <p class="text">협약 종료 날짜</p>
        <input type="text" name="hospPsEnd" id="birth_date" class="form-control" placeholder="19001010 형식입니다."><br>
         <p id="birth_check" class="check"> </p><br/>
        <p class="text">주소</p>
            ...
            <input type="text" class="form-control" id="sample4_jibunAddress" name="hospAddr" placeholder="지번주소"readonly="readonly">
            <span id="guide" style="color:#999;display:none"></span>
            <br/>
        <p class="text">전화번호</p>
        <input type="text" name="hospTel" id="phone" class="form-control" placeholder="010-0000-0000형식"><br><br>
  ...
  <script>
	 ...
	 var overChk = false;
		...
		$('#birth_date').blur(function(){
		    ...
		    if (dateStr.length <=8) {
				// 연도의 경우 1900 보다 작으면 false를 반환합니다.
			    if (1900 > year){
			    	
			    	$('#birth_check').text('날짜를 확인해주세요 :)');
