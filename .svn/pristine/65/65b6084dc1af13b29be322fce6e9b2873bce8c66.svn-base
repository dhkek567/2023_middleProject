...
@WebServlet("/board/advUpdate.do")
public class AdvUpdateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/views/board/advUpdateForm.jsp").forward(req, resp);
...
//		bv.setBafId(bafId);
		...
		resp.sendRedirect(req.getContextPath() + "/board/advDetail.do?bdNo=" + bdNo);
	}
