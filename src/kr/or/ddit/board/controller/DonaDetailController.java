...
@WebServlet( "/board/donaDetail.do")
public class DonaDetailController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/views/board/donaDetail.jsp").forward(req, resp);
