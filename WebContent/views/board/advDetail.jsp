		...
		<div class="board_view_wrap">
			<div class="board_view">
				...
				<div class="info">
					...
					<dl>
						<dt>
							<a href="./advReportInsert.do?bdNo=<%=bv.getBdNo() %>&memId=<%=bv.getMemId()%>" id="bt_but" style="font-style: oblique; color: crimson;">신고하기</a>
						</dt>
					</dl>
				</div>
...
%>
				<a href="./advUpdate.do?bdNo=<%=bv.getBdNo()%>">홍보글 수정</a> 
				<a href="./advDelete.do?bdNo=<%=bv.getBdNo()%>">홍보글 삭제</a>
<%
	}
%>
		 	</div>
