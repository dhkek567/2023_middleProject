...
<div style="text-align: center;">
	...
	<form action="advUpdate.do" id="test" method="post" enctype="multipart/form-data">
...
%>
				...
				<div class="bt_wrap">
                	<a class="test" type="submit" class="on" onclick="document.getElementById('test').submit();" >홍보글 수정</a>
